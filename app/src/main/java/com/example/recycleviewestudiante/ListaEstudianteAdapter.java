...
public class ListaEstudianteAdapter extends RecyclerView.Adapter<EstudianteViewHolder> {
    // atributos
    private Context c = null;
    private ArrayList<Estudiante> estudiantes;
    private LayoutInflater le_inflater;

    public ListaEstudianteAdapter(Context context, ArrayList<Estudiante> estudiantes) {
        this.c = context;
